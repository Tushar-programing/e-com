    ...
    <div id='post' className='w-full mt-5 h-screen mx-auto px-4 '>
        <div id='post1' className='w-1/2 h-full float-left'>
          <div id='post123' className='w-full'>
            ...
            {post.image[0]? <img height="900" className='float-left mx-6 mt-5 zoomable-image' style={{ width: '500px' }} src={authService.getFilePreview(post.image[img])} alt="Image" /> : null}
          </div>
